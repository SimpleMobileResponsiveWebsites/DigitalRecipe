...
def main():
    ...
    .stTextInput, .stSelectbox, .stNumberInput, .stButton {
        ...
        margin-left: auto;
        margin-right: auto;
        margin-bottom: 10px; /* Add margin here to increase spacing */
    }
    </style>
    """
    ...
    for i, entry in enumerate(st.session_state.ingredient_entries):
        ...
        with col2:
            entry["unit"] = st.selectbox("Units Of Food", ["tablespoons", "teaspoons", "grams", "ounces", "cups", "pints", "quarts", "gallons"], key=f"unit_{i}")
        with col2_1:
